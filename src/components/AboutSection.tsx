...
import {MusicNoteIcon, SparkleIcon, CalendarIcon, HeartIcon} from './icons';
  ...
  return (
    ...
    >
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 text-center px-4 flex items-center justify-center gap-3">
        <SparkleIcon className="flex-shrink-0" size={32} />
      ...
      <div className="bg-white/60 dark:bg-white/5 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-gray-200 dark:border-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start gap-3">
            <MusicNoteIcon className="flex-shrink-0 text-yellow-500 dark:text-yellow-400" size={32} />
            <p className="text-sm sm:text-base opacity-90">{t('aboutBullet1')}</p>
          </div>
          <div className="flex items-start gap-3">
            <SparkleIcon className="flex-shrink-0 text-blue-500 dark:text-blue-400" size={32} />
            <p className="text-sm sm:text-base opacity-90">{t('aboutBullet2')}</p>
          </div>
          <div className="flex items-start gap-3">
            <CalendarIcon className="flex-shrink-0 text-purple-500 dark:text-purple-400" size={32} />
            <p className="text-sm sm:text-base opacity-90">{t('aboutBullet3')}</p>
          </div>
          <div className="flex items-start gap-3">
            <HeartIcon className="flex-shrink-0 text-red-500 dark:text-red-400" size={32} />
